...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "8pfaIoASt0xlSFEOYo7bhDgPV";       // Change this
	public static final String REST_CONSUMER_SECRET = "NrUhZKCKplBqTQsV9EeHGPUy4Hn9J7MbzMZLeunQiUSWZXRabY"; // Change this
	...
	public void sendTweet(String message, long uid, AsyncHttpResponseHandler handler) {
	...
	public void unRetweet(long uid, AsyncHttpResponseHandler handler){
		String apiUrl = getApiUrl(String.format("statuses/unretweet/%s.json",uid));
		// Can specify query string params directly or through RequestParams.
		client.post(apiUrl, null, handler);
	}
